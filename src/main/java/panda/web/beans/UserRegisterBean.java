...
public class UserRegisterBean {
    private static final String PASSWORD_DONT_MATCH_MESSAGE = "Passwords don't match!";
    ...
    public void register() throws IOException {
        if (!this.doesPasswordsMatch()) {
            throw new IllegalArgumentException("PASSWORD_DONT_MATCH_MESSAGE");
        }
    ...
    private boolean doesPasswordsMatch() {
        return this.userRegisterBindingModel.getPassword().equals(this.userRegisterBindingModel.getConfirmPassword());
    }
}
